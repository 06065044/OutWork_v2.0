...
static NSString *visitTime = @"visitTIme";
...
//
//        //上一次不是登录的url进行判存储，如果存在
//        if ([[NSUserDefaults standardUserDefaults]objectForKey:visitTime]) {
//            NSDate *preDate  = [formatter dateFromString:[[NSUserDefaults standardUserDefaults] objectForKey:visitTime]];
//            [[NSUserDefaults standardUserDefaults]setObject:dateStr forKey:visitTime];
//            if (fabs([now timeIntervalSinceDate:preDate])>20*60) {
